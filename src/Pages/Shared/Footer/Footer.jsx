  ...
  return (
    <footer>
      <div className="footer gap-0 text-white">
        <aside className="text-center p-10 w-full block bg-[#1F2937]">
          <h1 className="uppercase text-3xl font-medium mb-6">Contact us</h1>
        ...
        <nav className="text-white text-center w-full h-full p-10 block bg-[#111827]">
          <h1 className="uppercase text-3xl font-medium mb-6">Follow US</h1>
      ...
      <div className="footer footer-center p-4 bg-black text-white font-medium text-xl">
        <aside>
